...
import { ActivitiesDatabaseService } from '@database/src/activities/activities.database.service';
import { CreateActivityDto } from './dtos';
import type { ActivityResponse } from './dtos';
...
export class ActivitiesService {
  ...
  async listActivities() {
    return await this.activitiesDatabaseService.find();
  }

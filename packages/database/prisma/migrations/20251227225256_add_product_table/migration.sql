...
-- CreateEnum
CREATE TYPE "public"."CategoryType" AS ENUM ('FARM', 'GARDEN', 'RESTAURANT', 'CAFE', 'BAR', 'MARKET', 'SPORTS', 'CULTURE', 'NATURE', 'ENTERTAINMENT', 'EDUCATION', 'WELLNESS', 'FAMILY', 'ADVENTURE', 'MUSIC', 'ART', 'FESTIVAL', 'SHOPPING', 'NIGHTLIFE', 'OTHER');
...
-- CreateIndex
CREATE INDEX "Product_activityId_idx" ON "public"."Product"("activityId");
...
-- AddForeignKey
ALTER TABLE "public"."Product" ADD CONSTRAINT "Product_activityId_fkey" FOREIGN KEY ("activityId") REFERENCES "public"."Activity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

...
export default function HomeScreen() {
  ...
  const fakeData = [
    {
      id: "act_01JDP9Y6M3Q4ZK8H2F5X9A1B7C",
      name: "Canlı Jazz Gecesi",
      description:
        "Şehrin en iyi jazz müzisyenleriyle unutulmaz bir canlı performans.",
      subtitle: "Cuma Akşamı Canlı Müzik",
      date: "2025-01-18",
      price: "250 TL",
      startTime: "2025-01-18T20:00:00.000Z",
      endTime: "2025-01-18T22:30:00.000Z",
      createdAt: "2025-01-10T09:15:42.123Z",
      updatedAt: "2025-01-12T16:48:10.456Z",
      locationId: "loc_01JDP8XK9F7A3M2QZ6L5C8R4T1",
      location: {
        id: "loc_01JDP8XK9F7A3M2QZ6L5C8R4T1",
        name: "Beyoğlu Jazz Club",
        address: "Asmalımescit Mah. İstiklal Cad. No:45",
        city: "İstanbul",
        canton: "Beyoğlu",
        latitude: 41.033964,
        longitude: 28.977556,
        createdAt: "2025-01-05T14:22:31.120Z",
        updatedAt: "2025-01-12T09:48:55.842Z",
      },
  ...
  const fetchActivities = async () => {
    try {
      setLoading(true)
      const data = setActivities(fakeData)
      setError(null)
    } catch (err) {
